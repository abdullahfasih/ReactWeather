...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nav = function Nav() {
	  return React.createElement(
	    ...
	    React.createElement(
	      Link,
	      { to: '/Examples', activeClassName: 'active', activeStyle: { fontWeight: 'bold' }, a: true },
	      'Examples'
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?q=London,uk&appid=3eb6d44958c7494188144abc77c79327&units=imperial';
